...
In contrast to this, a lower energy ground state is proposed to be created by charge carrier interaction is the so called excitonic insulator state, described by Kohn et al. in \cite{jerome1967, kohn1967}.
...
In fact a very recent ultrafast diffraction study argues, that the interlayer part of the \ac{CDW} is mainly stabilized by excitonic interactions, while the 2$\times$2 intralayer \ac{CDW} is driven by phononic interactions\cite{cheng2022}.
These experimental results are further corroborated by a preprint artcle by Novko et al.\cite{novko2022}.

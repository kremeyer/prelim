...
%EI
% put band structure and explain unstable enery region E<EG<EB \cite{kohn1967}
% -> excitonic and plasmonic softening
% -> experimentally observed in \cite{kogar2017}
% this will produce an electron density wave, which can produce a PLD
% long range order

%conclusion
% different driving forces; same outcome -> novel ground state

%misc
% describe difference in CDW/PLD from TiSe2 and other materials
% list values from table 4 in rossnagel review
